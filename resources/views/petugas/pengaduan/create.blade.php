        ...
        <div class="card-body px-lg-5 pt-0">
          ...
          <form role="form" action="{{route('pengaduan.store')}}" method="POST" class="text-center"
            ...
            <div class="md-form">
              ...
              value="{{old('isi_laporan')}}" autofocus required></textarea>
            ...
            <div class="md-form">
              <input placeholder="Plih Tanggal..." name="tgl_pelaporan" type="date" id="date-picker-example"
                class="form-control datepicker @error('tgl_pelaporan') is-invalid @enderror" value="{{ old('tgl_pelaporan')}}">
                @error('tgl_pelaporan')
