  ...
  <div class="row">
    ...
    <div class="col-md-10">
      ...
      <div class="card card-cascade narrower">
        ...
        <!--Card image-->
        <div class="view view-cascade gradient-card-header primary-color-dark narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
                  ...
                  <td>
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuReference">
                        ...
                        <a href="#" class="dropdown-item hapus" link="pengaduan" hapus-id="#id"><i
