...
<div class="col-md-2  animated fadeInLeft delay-1s">
  ...
  <br>
  <br>
  <a href="{{url('jenispdf')}}" class="btn btn-secondary btn-block"><i class="fas fa-print mr-1"></i> Cetak</a>
  <br>
  <br>
  <a href="{{url('jenisexcel')}}" class="btn btn-secondary  btn-block"><i class="fas fa-file-excel mr-1"></i> Excel</a>
</div>
