...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-2  animated fadeInLeft delay-1s">
      ...
      <br>
      <br>
      <a href="{{url('asalpdf')}}" class="btn btn-secondary btn-block"><i class="fas fa-print mr-1"></i> Cetak</a>
      <br>
      <br>
      <a href="{{url('asalexcel')}}" class="btn btn-secondary  btn-block"><i class="fas fa-file-excel mr-1"></i> Excel</a>
    </div>
    <div class="col-md-10  animated fadeInUp delay-1s">
      ...
      <div class="card card-cascade narrower">
        ...
        <!--Card image-->
        <div
          class="view view-cascade gradient-card-header primary-color-gradient narrower py-2 mx-4 mb-3 d-flex justify-content-between align-items-center">
