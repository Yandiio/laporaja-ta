  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-2 animated fadeInLeft delay-1s">
        ...
        <br>
        <a href="{{ url('petugaspdf') }}">
        <button class="btn btn-secondary btn-block"><i class="fas fa-print mr-1"></i> Cetak</button></a>
        <br>
        <a href="{{ url('petugasexcel') }}">
        <button class="btn btn-secondary  btn-block"><i class="fas fa-file-excel mr-1"></i> Excel</button></a>
      </div>
          ...
          <td>{{$pts->username}}</td>
           <td>
              <div class="btn-group">
                  ...
                  <a class="dropdown-item" href="{{route('petugas.show', $pts ->id)}}"><i class="fas fa-eye mr-1"></i>Detail</a>
                    <a class="dropdown-item" href="{{route('petugas.edit', $pts ->id)}}"><i class="fas fa-edit mr-1"></i>Edit</a>
                    <a href="#" class="dropdown-item hapus" link="petugas" hapus-id="{{$pts ->id}}"><i class="fas fa-trash mr-1"></i>Delete</a>
