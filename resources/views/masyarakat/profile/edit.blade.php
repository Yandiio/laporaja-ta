    ...
    <div class="col-md-12">
      ...
      <div class="card card-cascade narrower">
        ...
        <div class="card-body px-lg-5 pt-0">
          ...
          <!-- Form -->
        <form role="form" action="{{route('users.update', $pengguna->id)}}" method="POST" class="text-center"
            ...
            <div class="md-form">
              <input name="nik" type="number" value="{{$pengguna->nik}}" id="inputMDEx" class="form-control">
            ...
            <div class="md-form">
            <input name="username" type="text" value="{{$pengguna ->username}}" id="inputMDEx" class="form-control">
            <label for="materialSubscriptionFormEmail">Username</label>
            </div>
            <div class="md-form">
            <input name="telepon" type="text" value="{{$pengguna ->telepon}}" id="inputMDEx" class="form-control">
